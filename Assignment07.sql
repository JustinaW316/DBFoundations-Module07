...
-- 2024-05-28,JWoo,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JWoo')
	 Begin 
	  Alter Database [Assignment07DB_JWoo] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JWoo;
	 End
	Create Database Assignment07DB_JWoo;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JWoo;
...
CREATE VIEW vProductInventoriesWithPreviousMonthCountsWithKPI
AS
SELECT ProductName,
InventoryDate,
InventoryCount,
...
CREATE FUNCTION fProductInventoriesWithPreviousMonthCountsWithKPI
(@KPIValue INT) 
RETURNS TABLE AS
...
-- Check that it works:
Select * From fProductInventoriesWithPreviousMonthCountsWithKPI(1);
Select * From fProductInventoriesWithPreviousMonthCountsWithKPI(0);
Select * From fProductInventoriesWithPreviousMonthCountsWithKPI(-1);
